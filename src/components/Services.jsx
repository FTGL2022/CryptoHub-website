  ...
  const servicesData = [
    {
      ...
      descrption:
        "We offer support for a wide selection of leading digital currencies.",
    },
    {
      image: service2,
      title: "Recurring buys",
      descrption:
        "Explore a diverse selection of top digital currencies with our service.",
    },
    {
      image: service3,
      title: "Mobile apps",
      descrption:
        "CryptoHub includes support for a wide selection of top digital currencies.",
    },
  ];
  return (
